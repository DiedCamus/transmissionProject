...
def index():
    ...
    return render_template('myindex.html',filenames=filenames, the_message=the_message, my_message1="1234")
...
def upload():
    ...
    the_message = u'上传成功！'
    print "do this"
    return render_template('myindex.html', filenames=filenames, the_message=the_message)
